...
These regions are further subdivided and managed by five Area Control Centers (ACC), `r table_bra_eur |> dplyr::filter(str_starts(KPA, "number of TWR")) |> dplyr::pull(Brazil_2025) |> stringr::str_extract("^\\d+")` Tower facilities (TWR), one digital tower (D-TWR), `r table_bra_eur |> dplyr::filter(str_starts(KPA, "number of APP")) |> dplyr::pull(Brazil_2025)` Approach Units (APP) and 70 AFIS/Remote-AFIS.

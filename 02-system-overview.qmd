...
```{r}
#| label: tbl-HLC1
#| tbl-cap: "High Level Comparison 2025"
...
df |>
  kableExtra::kbl(
    booktabs = TRUE,
    col.names = c("KPA", "2023", "2024", "2025", "2023", "2024", "2025"),
    align = c("l", "c", "c", "c", "c", "c", "c"),
    escape = FALSE
  ) |>
  kableExtra::add_header_above(
    c(" " = 1, "Brazil" = 3, "Europe" = 3)
  ) |>
  kableExtra::kable_styling(
    full_width = ifelse(knitr::is_html_output(), TRUE, FALSE),
    font_size = ifelse(knitr::is_html_output(), 14, 8),
    latex_options = c("hold_position", "scale_down"),
    bootstrap_options = c("striped", "hover")
  ) |>
  kableExtra::column_spec(1, width = "5cm", bold = TRUE) |>
  kableExtra::column_spec(2:7, width = "1.2cm") |>
  kableExtra::add_footnote(
    label = "Brazil: c.f Performance report 2025 / Europe: c.f ACE report 2024",
    notation = "none"
  )
...
#
# 1. Open the file: data-src/table_BRA_EUR.csv
...
tbl <- df |>
  ...
  gt::tab_footnote(
    footnote = "Brazil: c.f Performance report 2025 / Europe: c.f ACE report 2024"
  )

...
df |>
  ...
  gt::tab_spanner(
    label = "Brazil",
    columns = c(Brazil_2023, Brazil_2024, Brazil_2025)
  ) |>
  gt::tab_spanner(
    label = "Europe",
    columns = c(Europe_2023, Europe_2024, Europe_2025)
  ) |>
  gt::cols_label(
    KPA         = "KPA",
    Brazil_2023 = "2023",
  ...
  gt::cols_width(
    KPA ~ gt::pct(40),
    c(Brazil_2023, Brazil_2024, Brazil_2025,
      Europe_2023, Europe_2024, Europe_2025) ~ gt::pct(10)
  ) |>
  gt::tab_options(
...
#    df[df$KPA == "row name here", "column_name"] <- "new value"
